...
const SIDEBAR_WIDTH_STORAGE_KEY = "neira.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "neira.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "neira.sidebar.collapsed";
