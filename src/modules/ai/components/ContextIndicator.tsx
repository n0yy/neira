...
// Ring + hover breakdown of the active session's context-window usage
// against the selected model's limit. Shared between the mini window
// header and the main dock composer toolbar.
