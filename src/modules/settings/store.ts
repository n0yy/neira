...
export const DEFAULT_THEME_ID = "neira-default";
...
const STORE_PATH = "neira-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "neira://prefs-changed";
...
const KEYS_CHANGED_EVENT = "neira://ai-keys-changed";
